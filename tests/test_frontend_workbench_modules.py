...
"""
        ...
        self.assertEqual(ordered["connectedVersioned"], {"smartImage": True, "smartMinimax": True, "classicImage": True, "classicGroup": True})
...
"""
    ...
    def test_classic_media_node_shell_reuses_legacy_gesture_and_link_state_machines(self):
        ...
        self.assertIn("command-registry.js?v=2026.09.14.2", page)
