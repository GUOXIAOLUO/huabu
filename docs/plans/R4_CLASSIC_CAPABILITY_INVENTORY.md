...
|---|---|---|---|
| Provider node creation (generator / Midjourney / ModelScope) | MIGRATE | Unified creation/mutation boundary | `addGeneratorNode`, `addMidjourneyNode`, `addMsGenNode` |
...
```json
{
  ...
  "capabilities": [
    {"id": "provider-node-creation", "category": "Provider cards", "disposition": "MIGRATE", "target_owner": "Unified creation/mutation boundary", "evidence": ["addGeneratorNode", "addMidjourneyNode", "addMsGenNode"]},
